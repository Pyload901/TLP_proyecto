...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_END = 4,                        /* END  */
  YYSYMBOL_VALOR = 5,                      /* VALOR  */
  YYSYMBOL_ID = 6,                         /* ID  */
  YYSYMBOL_SUMA = 7,                       /* SUMA  */
  YYSYMBOL_RESTA = 8,                      /* RESTA  */
  YYSYMBOL_MULT = 9,                       /* MULT  */
  YYSYMBOL_DIV = 10,                       /* DIV  */
  YYSYMBOL_FUNCTION = 11,                  /* FUNCTION  */
  YYSYMBOL_EXEC = 12,                      /* EXEC  */
  ...
  YYSYMBOL_Bloque = 31,                    /* Bloque  */
  YYSYMBOL_BloqueAux = 32,                 /* BloqueAux  */
...
static const char *const yytname[] =
{
  ...
  "VALOR", "ID", "SUMA", "RESTA", "MULT", "DIV", "FUNCTION", "EXEC",
  "LPAREN", "RPAREN", "COMMA", "SEMICOLON", "TRUE", "FALSE", "OR", "AND",
  "NOT", "LT", "LEQ", "GT", "GEQ", "EQ", "NEQ", "ASIGNACION", "$accept",
  "Programa", "Bloque", "BloqueAux", "Asignacion", "Expresion", YY_NULLPTR
};
...
#line 29 "small_parser.y"
                  { root = (yyvsp[0].node);}
#line 1096 "parser.tab.c"
    break;

  case 3: /* Bloque: START BloqueAux END  */
#line 31 "small_parser.y"
                             { (yyval.node) = (yyvsp[-1].node);}
#line 1102 "parser.tab.c"
    break;

  case 4: /* BloqueAux: Asignacion SEMICOLON  */
#line 33 "small_parser.y"
                                { (yyval.node) = (yyvsp[-1].node); }
#line 1108 "parser.tab.c"
    break;

  case 5: /* Asignacion: ID ASIGNACION Expresion  */
#line 35 "small_parser.y"
                                    { (yyval.node) = new_assignment_node((yyvsp[-2].id), (yyvsp[0].node)); }
#line 1114 "parser.tab.c"
    break;

  case 6: /* Expresion: VALOR  */
#line 37 "small_parser.y"
